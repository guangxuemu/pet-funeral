...
CITIES_DIR = PROJECT_DIR / "docs/cities"
...
CITY_DATA_FILE = PROJECT_DIR / "city_data.json"
...
DISTRICT_DATA = {
    ...
    "重庆": ["万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "渝北区", "巴南区", "黔江区", "长寿区", "江津区", "合川区", "永川区", "南川区", "綦江区", "大足区", "璧山区", "铜梁区", "潼南区", "荣昌区"],
    ...
    "南通": ["崇川区", "港闸区", "通州区", "海安市", "如东县", "如皋市", "启东市", "海门区"],
    ...
    "东莞": ["莞城街道", "南城街道", "东城街道", "万江街道", "石龙镇", "虎门镇", "长安镇", "厚街镇", "塘厦镇", "常平镇", "大朗镇", "寮步镇", "大岭山镇", "凤岗镇", "清溪镇", "樟木头镇"],
    "佛山": ["禅城区", "南海区", "顺德区", "三水区", "高明区"],
    "珠海": ["香洲区", "斗门区", "金湾区"],
    "惠州": ["惠城区", "惠阳区", "博罗县", "惠东县", "龙门县"],
    "中山": ["石岐街道", "东区街道", "西区街道", "南区街道", "五桂山街道", "中山港街道", "小榄镇", "古镇镇", "东凤镇", "黄圃镇", "三角镇", "民众镇", "南朗镇", "三乡镇", "坦洲镇"],
    ...
    "邵阳": ["双清区", "大祥区", "北塔区", "邵东市", "新邵县", "邵阳县", "隆回县", "洞口县", "绥宁县", "新宁县", "城步苗族自治县", "武冈市"],
    ...
    "漳州": ["芗城区", "龙文区", "龙海区", "云霄县", "漳浦县", "诏安县", "长泰县", "东山县", "南靖县", "平和县", "华安县"],
    "莆田": ["城厢区", "涵江区", "荔城区", "秀屿区", "仙游县"],
    "宁德": ["蕉城区", "霞浦县", "古田县", "屏南县", "寿宁县", "周宁县", "柘荣县", "福安市", "福鼎市"],
    "三明": ["梅列区", "三元区", "明溪县", "清流县", "宁化县", "大田县", "尤溪县", "沙县区", "将乐县", "泰宁县", "建宁县", "永安市"],
    ...
    "抚州": ["临川区", "南城县", "黎川县", "南丰县", "崇仁县", "乐安县", "宜黄县", "金溪县", "资溪县", "东乡区", "广昌县"],
    ...
    "伊春": ["伊美区", "乌翠区", "友好区", "金林区", "嘉荫县", "汤旺县", "丰林县", "大箐山县", "南岔县", "铁力市"],
    ...
    "梧州": ["万秀区", "长洲区", "龙圩区", "苍梧县", "藤县", "岑溪市", "蒙山县"],
    "北海": ["海城区", "银海区", "铁山港区", "合浦县"],
    "防城港": ["港口区", "防城区", "上思县", "东兴市"],
    "钦州": ["钦南区", "钦北区", "灵山县", "浦北县"],
    "贵港": ["港北区", "港南区", "覃塘区", "平南县", "桂平市"],
    "玉林": ["玉州区", "福绵区", "容县", "陆川县", "博白县", "兴业县", "北流市"],
    "百色": ["右江区", "田阳区", "田东县", "平果市", "德保县", "那坡县", "凌云县", "乐业县", "田林县", "西林县", "隆林各族自治县", "靖西市"],
    ...
    "承德": ["双桥区", "双滦区", "鹰手营子矿区", "承德县", "兴隆县", "平泉市", "滦平县", "隆化县", "丰宁满族自治县", "宽城满族自治县", "围场满族蒙古族自治县"],
...
def build_district_prompt(district: str, keywords: dict) -> str:
    """区县文章提示词"""
...
def generate_city_districts(city_name: str, province: str, keywords: dict):
    """生成指定城市的区县文章"""
    
    if city_name not in DISTRICT_DATA:
        print(f"⚠️ {city_name}: 无区县数据")
        return 0, 0
    
    districts = DISTRICT_DATA[city_name]
    
    # 处理特殊城市（直辖市的区县文件放在城市同名目录下）
    if city_name in ["北京", "上海", "天津", "重庆"]:
        output_dir = CITIES_DIR / province / city_name
    else:
        output_dir = CITIES_DIR / province / city_name
    ...
    for district in districts:
        ...
        if output_file.exists():
            print(f"⏭️ {city_name}/{district}: 已存在")
            continue
        
        prompt = build_district_prompt(district, keywords)
        ...
        if content:
            ...
            title = page.split('\n')[0]
            print(f"✅ {city_name}/{district}: {title[:40]}...")
            success += 1
            time.sleep(1)  # 避免API限流
        else:
            print(f"❌ {city_name}/{district}: 失败")
            failed += 1
...
def main():
    ...
    city_province = city_data.get('city_province', {})
    ...
    print("=" * 60)
    print(f"批量生成区县文章，共 {len(cities)} 个城市")
    print("=" * 60)
    
    for city in cities:
        province = city_province.get(city, city)
        success, failed = generate_city_districts(city, province, keywords)
        total_success += success
        total_failed += failed
        
        if success > 0 or failed > 0:
            print(f"📊 {city}: 成功 {success}, 失败 {failed}")
